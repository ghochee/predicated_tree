...
// - This is not a part of 'iterator' because given an accessor the ability to
//   'traverse' it to the 'next' inorder position is different from a pre-baked
//   C++ construct which ties the accessor along with the traversal order. OTOH
//   this functionality will definitely need to be used in the iterator.
